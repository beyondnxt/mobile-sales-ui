...
class CreateTaskWidget extends StatefulWidget {
  final int? id;
  const CreateTaskWidget({super.key, this.id});
              ...
              CustomElevatedButton(
                  onTap: () async {
                    if (provider.isLoading) {
                      ...
                      if (provider.customerNameController.text.isEmpty) {
                      ...
                      } else if (provider.leadTypeController.text.isEmpty) {
                        Fluttertoast.showToast(
                            msg: "Please select a Task Type");
                      } else if (provider.statusTypeController.text.isEmpty) {
                        ...
                        if (widget.id == null) {
                          ...
                          provider.postTask(
                            ...
                            assignTo: provider
                                    .assignToPersonIDController.text.isEmpty
                                ? null
                                : int.parse(
                                    provider.assignToPersonIDController.text),
                            description:
                          ...
                          provider.editTaskApi(
                            ...
                            customerId:
                                int.parse(provider.customerNameController.text),
                            assignTo:provider.assignToPersonIDController.text.isEmpty?null: int.parse(
                                provider.assignToPersonIDController.text),
                            description:
                                provider.descriptionNameController.text,
                            status: status,
